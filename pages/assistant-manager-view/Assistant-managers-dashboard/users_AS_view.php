            ...
            ?>
                        ...
                        <?php
                            if($_SESSION['type'] == 'manager'){
                                ...
                                echo'<li class="nav-item"><a class="nav-link" href="assistant_manager_dashboard.php">Assistant Manager Dashboard</a></li>';
                            }elseif($_SESSION['type'] == 'admin'){
                        ...
                        <?php
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li>
                                    <a class="dropdown-item active" href="users_AS_view.php">All Staff</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="transactions_AS_view.php">Transactions</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="products_AS_view.php">Product</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="suppliers_AS_view.php">Suppliers</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
