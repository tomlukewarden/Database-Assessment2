...
<body>
    ...
    <header>
        <h1 class="d-flex justify-content-center">November Payslip</h1>
    ...
    <main class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <?php
                    //get name
                    $sql = "SELECT first_name, last_name, hourly_rate, hours_worked FROM payslip_november WHERE staff_id = " . $_SESSION['username'];
            ...
            <div class="col">
                ...
                <?php
                    //get name
                    $sql = "SELECT national_insurance, taxcode FROM payslip_november WHERE staff_id = " . $_SESSION['username'];
                    $result = mysqli_query($conn, $sql);
                    if ($result) {
        ...
        <div class="row">
            <div class="col">
                ...
                <?php
                    //get name
                    $sql = "SELECT regular_pay, overtime_pay, total_pay FROM payslip_november WHERE staff_id = " . $_SESSION['username'];
                    $result = mysqli_query($conn, $sql);
                    if ($result) {
        ...
        <div class="row">
            <div class="col">
                <table class="table table-secondary">
                    ...
                    <?php
                    //get name
                    $sql = "SELECT tax, ni_deduction, pension, total_deductions FROM payslip_november WHERE staff_id = " . $_SESSION['username'];
                    $result = mysqli_query($conn, $sql);
                    if ($result) {
        ...
        <div class="row">
            <div class="col">
                ...
                <?php
                    //get name
                    $sql = "SELECT total_net_pay FROM payslip_november WHERE staff_id = " . $_SESSION['username'];
                    $result = mysqli_query($conn, $sql);
                    if ($result) {
